...
const LINES = [
  { text: "Initializing Portfolio...", duration: 700 },
  { text: "Loading Yash Ganesh...", duration: 700 },
  { text: "Launching Experience...", duration: 700 },
  ...
  useEffect(() => {
    ...
    charTimer.current = setInterval(() => {
      ...
      if (i >= current.length) {
        ...
        lineTimer.current = setTimeout(() => setLineIdx(idx => idx + 1), 240);
      }
    }, 24);
    return () => {
      clearInterval(charTimer.current);
