...
- New direction: make the homepage video-driven, using three scroll-scrubbed cinematic clips. The supplied `Build What Matters` screenshot is the final-act visual anchor: preserve its composition, grade, subject pose, and copy; animate it as a seamless loop with a gently hovering YG sculpture, subtle cyan particles, and natural blinking/breathing only.
